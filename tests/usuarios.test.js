...
describe("Usuários (auth)", () => {
    // agrupa testes de autenticação/usuários

    test("register: cria usuário (ou 409 se já existir)", async () => {
        // teste de registro
    ...
    test("login: autentica e seta cookie refresh", async () => {
        // teste de login + cookie de refresh
    ...
    test("refresh: funciona com cookie (agent)", async () => {
        // teste do endpoint de refresh usando cookies persistidos
    ...
    test("logout: responde 204", async () => {
        // teste de logout (deve limpar cookie e retornar 204)
